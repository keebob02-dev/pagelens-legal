...
- Reads your active theme's files to detect leftover code left behind by previously-uninstalled apps
...
- **Free tier:** one scan per 7 days, see every finding, fix manually in Shopify's theme editor.
- **Pro tier (USD $15/month at launch):** unlimited scans, weekly automatic background scan, speed history, priority email support, and every additional feature we ship.
...
You agree NOT to:
- Use the App to scan any store you don't own or have written permission to administer
